...
namespace HotelManagmanetSystem.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        public BookingsController(HotelManagmanetSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Booking>> PostBooking(Booking booking)
        {
          if (_context.Booking == null)
          {
              return Problem("Entity set 'HotelManagmanetSystemContext.Booking'  is null.");
          }
        ...
        {
            return (_context.Booking?.Any(e => e.BookId == id)).GetValueOrDefault();
        }
    }
}
